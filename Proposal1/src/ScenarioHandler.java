...
public class ScenarioHandler {
	...
	private void generateScenarioList() {
		...
		scenariosArrayList.add(new Scenario(
				...
				new Image("1920px-Electronic_cigarette_vape_pen.JPG"),
		...
		scenariosArrayList.add(new Scenario(
				...
				new Image("800px-Smoke_Screen_(16582794210).jpg"),
		...
		scenariosArrayList.add(new Scenario(
				...
				new Image("1920px-Juul_in_hand.jpg"),
		...
		scenariosArrayList.add(new Scenario(
				...
				new Image("320px-Juul_vaping_device,_with_one_pod_(cropped).jpg"),
		...
		scenariosArrayList.add(new Scenario(
				...
				new Image("1920px-Teen_vaping_is_now_getting_popular_due_to_discreet_vaping_devices.jpg"),
